...
The browser plugin uses **Playwright CLI** (Microsoft) exclusively.
Provides structured DOM snapshots with stable element references (`e1`, `e2`, ...), mobile/device emulation, network request mocking, full tab management, and DevTools tracing.
